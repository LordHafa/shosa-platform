...
## SACCO automation and audit controls

The launch package includes safeguards for SACCO registration and payment flow. Public users cannot self-assign Founder or Executive membership categories. Contribution plans and fixed SACCO amounts are system-controlled. See `docs/SACCO_AUTOMATION_AND_AUDIT_DESIGN.md`.


## UI Brand System 2026

The project includes a refreshed youthful SHOSA blue/gold visual system with Classic/Bright theme modes. See `docs/UI_BRAND_SYSTEM_2026.md`.
